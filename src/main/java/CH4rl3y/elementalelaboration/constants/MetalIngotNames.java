...
public final class MetalIngotNames {
    ...
    public static final String HAFNIUM_INGOT = "hafniumIngot";
    ...
    public static final String LITHIUM_INGOT = "lithiumIngot";
    ...
    public static final String NIOBIUM_INGOT = "niobiumIngot";
    public static final String OSMIUM_INGOT = "osmiumIngot";
    public static final String PALLADIUM_INGOT = "palladiumIngot";
